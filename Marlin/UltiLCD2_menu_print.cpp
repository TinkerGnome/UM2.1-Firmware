...
#if EXTRUDERS > 1
        char buffer_len[10];
        float_to_string(toolchange_retractlen[active_extruder] / volume_to_filament_length[active_extruder], buffer_len, NULL);
        sprintf_P(buffer, PSTR("G92 E%s"), buffer_len);
#else
